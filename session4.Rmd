...
The `forcats` package in the `tidyverse` provides a number of functions
for manipulating factors and their levels. In this case the `fct_relevel` 
function provides a methods with slightly less typing.
We just want to move "10" to the end of levels.
...
:::exercise
2. Use `iris` data set to create a box plot showing the distribution of petal lengths based on the `iris` data set.
